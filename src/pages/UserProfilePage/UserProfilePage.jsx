  ...
  return (
    <section className="user-profile_page">
      ...
      <p className="user-profile_description">
        ...
        en una cafetería acogedora, tomar un buen café y simplemente observar el
        ir y venir de la gente. Busco a alguien que quiera acompañarme en mis
        paseos, alguien con quien compartir una charla amena, una risa
